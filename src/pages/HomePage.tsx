...
import { ArrowRight, Layers, Lock, Ruler } from "lucide-react";
...
const TOOLS = [
  {
    id: "concrete" as const satisfies ToolId,
  ...
  {
    id: "stairs" as const satisfies ToolId,
    to: "/stairs" as const,
    title: "Stair set-out",
  ...
  {
    id: "running" as const satisfies ToolId,
    to: "/running" as const,
  ...
  {
    id: "triangle" as const satisfies ToolId,
  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-3xl flex-col px-4 py-8 sm:px-6">
      ...
      <p className="mt-auto pt-10 text-xs leading-normal text-subtle">
        ...
        Confirm with the certifier on the job. No ads.
      </p>
